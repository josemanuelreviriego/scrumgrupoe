...
public class HojaSprites {
	...
	public HojaSprites(final String ruta, final int tamanhoSprites, final boolean HojaOpaca) {
		...
		anchoHojaEnSprites = anchoHojaEnPixeles / tamanhoSprites;
		altoHojaEnSprites = altoHojaEnPixeles / tamanhoSprites;
	...
	// Devuelve un sprite dependiendo de la localizacion
