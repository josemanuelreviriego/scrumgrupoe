...
public class CargadorRecursos {
	public static BufferedImage cargarImagenCompatibleOpaca(final String ruta) {
		...
		// Nos aseguramos de crear la imagen compatible con todos los
		// ordenadores. Obtenemos la configuracion grafica del monitor que
		// estamos usando.
		...
		// Crear graficos G que dibujen en la imagenAcelerado
		Graphics g = imagenAcelerada.getGraphics();
		// Dibujamos la imagen en la posicion 0 0 y luego borramos el objeto g
