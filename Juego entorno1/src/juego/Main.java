...
public class Main extends Canvas implements Runnable {
	...
	private void actualizar() {
		...
		jugador.actualizar();  //Actualizamos el teclado
	...
	private void mostrar() {
		...
		mapa.mostrar(jugador.obtenerPosicionX() - pantalla.getAncho() /2 + jugador.obtenSprite().getlado()/2,
				jugador.obtenerPosicionY() - pantalla.getAlto() /2 + jugador.obtenSprite().getlado()/2, pantalla);
		...
		g.drawString("y= " + jugador.obtenerPosicionY(), 10, 75);
