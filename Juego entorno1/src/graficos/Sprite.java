...
public final class Sprite {
	...
	//Coleccion de srpites del personaje	(32, 0/COLUMNA, 1/FILA, 0)
	public static final Sprite ARRIBA0 = new Sprite(32, 0, 0, 0, HojaSprites.Sonic );
	public static final Sprite ARRIBA1 = new Sprite(32, 1, 0, 0, HojaSprites.Sonic );
	public static final Sprite ARRIBA2 = new Sprite(32, 2, 0, 0, HojaSprites.Sonic );
	
	public static final Sprite ABAJO0 = new Sprite(32, 0, 1, 0, HojaSprites.Sonic );
	public static final Sprite ABAJO1 = new Sprite(32, 1, 1, 0, HojaSprites.Sonic );
	public static final Sprite ABAJO2 = new Sprite(32, 2, 1, 0, HojaSprites.Sonic );
	
	public static final Sprite DERECHA0 = new Sprite(32, 0, 2, 0, HojaSprites.Sonic );
	public static final Sprite DERECHA1 = new Sprite(32, 1, 2, 0, HojaSprites.Sonic );
	public static final Sprite DERECHA2 = new Sprite(32, 2, 2, 0, HojaSprites.Sonic );
	
	
	public static final Sprite IZQUIERDA0 = new Sprite(32, 0, 3, 0, HojaSprites.Sonic );
	public static final Sprite IZQUIERDA1 = new Sprite(32, 1, 3, 0, HojaSprites.Sonic );
	public static final Sprite IZQUIERDA2 = new Sprite(32, 2, 3, 0, HojaSprites.Sonic );
